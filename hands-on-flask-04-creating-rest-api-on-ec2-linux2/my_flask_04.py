...
def init_todo_db():
    ...
    VALUES
        ...
        ("Cloudformation Documentation", "Study and learn how to read cloudformation", 0),
...
# Write a function named `home` which returns 'Welcome to the Serkan's To-Do API Service',
...
def update_task(task_id):
    ...
    task['is_done'] = int(requesu.json.get('is_done', int(task['is_done'])))
    return jsonify({'update task': change_task(task)})
